...
Template matching is a form of holistic recognition in which the units of
analysis are the same size as the patterns to be recognized. [Massaro1998]_

Template matching has some limitations:

- Template matching has no way to evaluate importance of matches.
