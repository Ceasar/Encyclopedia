...
<a name="conversational-maxim"></a>
Conversational Maxim
-----------------------------------------------------------------------------

A conversational maxim is ...

Grice offered four maxims (echoing Kant):

1. **Maxim of Quantity**
    1. Make your contribution as informative as is required (for the current purpose of the exchange)
    2. Do not make your contribution more informative than is required
2. **Maxim of Quality**
    0. Try to make your contribution one that is true. (necessary for other maxims)
...
The observance of some of these maxims is a matter of less urgency than the observance of others.[10]

    * Prolixity is less evil than false

Note: Many other maxims exist. (e.g. aesthetic, social, moral (e.g. be polite))
...
A setting is a [scene](#scene) and a [medium](#medium) combined.[4]
...
<a name="joint-project"></a>
Joint Project
-----------------------------------------------------------------------------

A joint project is...

Joint projects differ in size.[1]

Joint projects can only be accomplished by the participants working together.[1]

### Minimal Joint project

Conversations seem less a sequence of single actions than a chain of paired actions.[1]

Adjacency pairs form units in which people achieve certain goals together, certain joint purposes.[1]
